/* Parallelized code in OpenMP
   This program calculates the estimator which extracts the ellipticity of the halo, using my developed 3-point cross-correlation method, it does stacking as well.
